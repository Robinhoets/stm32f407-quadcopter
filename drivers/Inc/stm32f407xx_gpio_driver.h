...
#define GPIO_MODE_IT_FT			4			// falling edge interrupt trigger
#define GPIO_MODE_IT_RT			5			// rising edge interrupt trigger
#define GPIO_MODE_IT_RFT		6			// rising edge/falling edge interrupt trigger
